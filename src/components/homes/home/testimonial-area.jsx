...
const testimonial_data = [
  {
    ...
    des: (
      <>
        Our courses provide an exclusive learning experience with an experienced UX/UI designer who shares the secrets to creating amazing user interfaces.
      </>
    ),
  },
  {
    ...
    des: (
      <>
        Our courses provide the opportunity to learn under the guidance of an experienced professional who makes complex development concepts accessible and understandable.
      </>
    ),
  },
  {
    ...
    des: (
      <>
        Under the guidance of an experienced Devon Lane, you will learn the skills to produce creative and informative content to engage your audience.
      </>
    ),
  },
